Pod::Spec.new do |s|
  ...
  s.name         = "BridgewellAdmobSDK"
  s.version      = "4.3.0"
  s.summary      = "BridgewellAdmobSDK is a lightweight framework that integrates directly with Prebid Server."
  ...
  s.requires_arc = true
  s.vendored_frameworks = 'BridgewellAdmobSDK/BridgewellAdmobSDK.xcframework'
  s.user_target_xcconfig = { 'BUILD_LIBRARY_FOR_DISTRIBUTION' => 'YES' }
  s.pod_target_xcconfig = { 'BUILD_LIBRARY_FOR_DISTRIBUTION' => 'YES' }

  # Dependencies
  s.dependency 'BridgewellSDK', '4.3.0'
